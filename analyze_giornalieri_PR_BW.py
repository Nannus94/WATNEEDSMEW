"""
Valid pixel masks for PR (rainfall) and BW (irrigation water),
...
for VAR, (VAR_LABEL, CMAP) in VARS.items():
    KEY     = f"output{VAR}"
    ...
    masks[VAR] = {"mask": valid, "label": VAR_LABEL, "cmap": CMAP,
...
plt.tight_layout()
out_png = OUT_DIR / f"valid_pixels_PR_BW_crop{CROP}_SURF.png"
